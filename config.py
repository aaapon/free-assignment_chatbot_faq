...
# 画面表示系
# ==========================================
APP_NAME = "カスタマーサポートチャットボット"
APP_DESCRIPTION = "よくある質問に答えるAIチャットボットです。よくある質問をクリック、また自由に質問してみてください。"
...
NO_DOC_MATCH_MESSAGE = """
    入力内容と関連する質問が見つかりませんでした。\n
    入力内容を変更してください。
"""
CONVERSATION_LOG_ERROR_MESSAGE = "過去の会話履歴の表示に失敗しました。"
GET_LLM_RESPONSE_ERROR_MESSAGE = "回答生成に失敗しました。"
DISP_ANSWER_ERROR_MESSAGE = "回答表示に失敗しました。"
CHATBOT_ERROR_MESSAGE = "チャットボットの回答生成中にエラーが発生しました。"

# ==========================================
# データ関連の設定
# ==========================================
RAG_TOP_FOLDER_PATH = "./data"
RAG_FAQ_FILE_PATH = "./data/faq_data.csv"